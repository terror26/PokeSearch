...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate,MyProtocol {
    ...
    func createSighting(forLocation location: CLLocation, withPokemon pokeId: Int) {
        ...
        geoFire.setLocation(location, forKey: "\(pokeId+1)")
    }
    ...
    @IBAction func spotRandomPokemon(_ sender: AnyObject) {
        ...
        let secondViewController = self.storyboard?.instantiateViewController(withIdentifier: "PokeCollection") as! PokeCollection

        secondViewController.delegate = self

        present(secondViewController, animated: true, completion: nil)
//        let identifier = "PokeCollection"
//        let myVC = storyboard?.instantiateViewController(withIdentifier: identifier) as! PokeCollection
...
//        if let viewController = segue.destination as? PokeCollections {
